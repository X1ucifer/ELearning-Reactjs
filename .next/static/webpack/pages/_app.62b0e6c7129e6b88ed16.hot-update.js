  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(function () {
    ...
    document.addEventListener("scroll", function () {
      if (window.scrollY > 170) {
        elementId.classList.add("is-sticky"); // } else {
